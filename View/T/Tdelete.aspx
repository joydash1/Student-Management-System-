<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tdelete.aspx.cs" Inherits="StudentManagementSystem.View.T.Tdelete" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       <div class="container-fluid center-block" style="height:auto; border: 5px solid black; margin-top: 30px; background-color: pink; padding-bottom:30px;">
        ...
        <div class="row" style="height: 620px; border: 5px solid grey; margin: 5px; margin-top: 30px; background-color: wheat; padding-inline: 20px;">
            ...
            <asp:Button ID="tdeletebtn" runat="server" Text="Delete"  class="btn btn-danger" style="margin-top: 20px; width: 100%;" OnClientClick="if(!confirm('Are You Want To Delete?')) return false;" OnClick="tdeletebtn_Click"/>
