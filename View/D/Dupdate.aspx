<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dupdate.aspx.cs" Inherits="StudentManagementSystem.View.D.Dupdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container-fluid center-block" style="height:auto; border: 5px solid black; margin-top: 30px; background-color: pink; padding-bottom:30px;">
        ...
        <div class="row" style="height: 330px; border: 5px solid grey; margin: 5px; margin-top: 30px; background-color: wheat; padding-inline: 20px;">
            <h1 class="text-center text-info">Update Department Form</h1>         
            ...
            <asp:Button ID="Departmentbtn" runat="server" Text="Update"  class="btn btn-info" style="margin-top: 20px; width: 100%;" OnClick="Departmentbtn_Click"/>
