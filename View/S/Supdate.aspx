<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Supdate.aspx.cs" Inherits="StudentManagementSystem.View.S.Supdate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <div class="container-fluid center-block" style="height: auto; border: 5px solid black; margin-top: 30px; background-color: pink; padding-bottom: 30px;">
            ...
            <div class="row" style="height: 680px; border: 5px solid grey; margin: 5px; margin-top: 30px; background-color: wheat; padding-inline: 20px;">
                <h1 class="text-center text-info">Update Your Registration Form</h1>
                <div class="col-lg-12">
                ...
                <asp:Button ID="StudenUpdatetbtn" runat="server" Text="Update" class="btn btn-info" Style="margin-top: 20px; width: 100%;" OnClick="StudenUpdatetbtn_Click" />
            </div>
        </div>
